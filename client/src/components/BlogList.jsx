...
const BlogList = () => {
  ...
  return (
    <div>
      <div className='flex justify-center gap-4 sm:gap-6 my-10 relative'>
      ...
      <div className='grid grid-cols-1 sm:grid-cols-2 p-0 md:grid-cols-3 xl:grid-cols-4 gap-8 mb-24 mmx-8 sm:mx-16 xl:mx-40'>
